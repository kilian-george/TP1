...
/*******
 * <p>
 * Title: PasswordEvaluationTestingAutomation Class.
 * </p>
 * 
 * <p>
 * Description: A Java demonstration for semi-automated tests
 * </p>
 * 
 * <p>
...
public class PasswordEvaluationTestingAutomation {
	...
	/*
	 * This mainline displays a header to the console, performs a sequence of test
	 * cases, and then displays a footer with a summary of the results
	 */
	public static void main(String[] args) {
		...
		performTestCase(1, "1qaz!QAZ", true);

		// This is a properly written negative test
		performTestCase(2, "bb1", false);
		...
		// performTestCase(3, "2wsx@WSX", false);
		...
		// performTestCase(4, "1223", true);
		// performTestCase(5, "", true);
		// Add more test cases here
		// this test has a blank on the inital and false, meaning it should
		// always return false
		performTestCase(6, "", false);
		// should fail due to missiong number
		performTestCase(7, "qaz!QAZ", false);
		// should fail due to missing special char
		performTestCase(8, "1qazQAZA", false);
		// fails due to missing uppercase letter
		performTestCase(9, "1qaz!qaz1qaz", false);
	 ...
	 * that the interactive JavaFX mainline uses, interprets the returned value, and
	 * displays the interpreted result.
	 */
