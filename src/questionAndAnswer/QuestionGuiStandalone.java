...
public class QuestionGuiStandalone {
	...
	private void showDetailView(Question question) {
		...
		ScrollPane answersScrollPane = new ScrollPane(answersBox);
		answersScrollPane.setFitToWidth(true);
		answersScrollPane.setPrefViewportHeight(300);  // or whatever height you want
		answersScrollPane.setHbarPolicy(ScrollPane.ScrollBarPolicy.NEVER);
		answersScrollPane.setVbarPolicy(ScrollPane.ScrollBarPolicy.AS_NEEDED);

		detailBox.getChildren().add(answersScrollPane);
