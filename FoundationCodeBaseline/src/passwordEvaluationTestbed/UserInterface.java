...
public class UserInterface {
	...
	public UserInterface(Pane theRoot) {
		...
		// Establish the text input operand field and when anything changes in the
		// password,
		...
		// Establish the Go button, position it, and link it to methods to accomplish
		// its work
		...
		// have text or not
		theRoot.getChildren().addAll(label_ApplicationTitle, label_Password, text_Password, noInputFound,
